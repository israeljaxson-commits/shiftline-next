...
export function Testimonials() {
  return (
    <section data-section="true" data-journey="voices" className="mx-auto max-w-[1400px] px-6 py-36 lg:px-10 lg:py-48 xl:py-56">
      <Reveal variant="text">
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        {testimonials.map((testimonial, index) => (
          <Reveal key={testimonial.role} variant="card" delay={index * 0.08} className={index === 0 ? "lg:col-span-7" : "lg:col-span-5"}>
            <Card className={index === 0 ? "testimonial-feature border border-line/85 bg-white p-8 lg:p-10" : "testimonial-card border border-line/85 bg-white p-8 lg:p-9"} lift>
