...
export function SectionHeading({ eyebrow, title, description, dark, className, eyebrowClassName }: SectionHeadingProps) {
  return (
    <div className={cn("max-w-3xl", className)}>
      <p className={cn("kicker-line mb-5 font-display text-[1.14rem] font-bold italic tracking-[0.02em]", dark ? "text-emerald-bright" : "text-emerald-deep", eyebrowClassName)}>{eyebrow}</p>
