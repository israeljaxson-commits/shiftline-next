...
export function Services() {
  return (
    <section id="services" data-section="true" data-journey="services" className="mx-auto max-w-[1400px] px-6 py-36 lg:px-10 lg:py-48 xl:py-56">
      <Reveal variant="text">
      ...
      <div className="divide-y divide-line border-y border-line">
        {services.map((service, index) => (
          <Reveal key={service.id} variant="card" delay={index * 0.05}>
            <div data-dir={index % 2 === 0 ? "right" : "left"} className={index % 2 === 0 ? "service-row group grid items-center gap-7 bg-paper py-12 lg:grid-cols-12 lg:gap-8" : "service-row group grid items-center gap-7 bg-beige/45 py-12 lg:grid-cols-12 lg:gap-8"}>
