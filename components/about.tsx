...
export function About() {
  return (
    <section id="about" data-section="true" data-journey="about" className="section-shell mx-auto max-w-[1400px] px-6 py-34 lg:px-10 lg:py-46 xl:py-54">
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-18">
        ...
        <div className="lg:col-span-7 lg:pt-16">
          ...
          <div className="about-pillars mt-16 grid gap-4 border-t border-line/80 pt-10 sm:grid-cols-3">
